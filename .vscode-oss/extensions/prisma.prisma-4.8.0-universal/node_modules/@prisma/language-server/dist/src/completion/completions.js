...
function getSuggestionForDataSourceField(block, lines, position) {
    ...
    const postgresExtensionsEnabled = (_a = (0, util_1.getAllPreviewFeaturesFromGenerators)(lines)) === null || _a === void 0 ? void 0 : _a.includes('postgresqlextensions');
    const isPostgres = (_b = (0, util_1.getFirstDatasourceProvider)(lines)) === null || _b === void 0 ? void 0 : _b.includes('postgres');
